...
一个使用原生 HTML、CSS、JavaScript 构建的个人主页项目，无需任何框架依赖，轻量高效。包含前端展示页面、后台管理系统，以及全新的 **AI 小说改编助手**，让你轻松定制属于自己的个人主页和创作工具。
...
- 🤖 **AI 改编助手** - 全新的小说改编为短剧的智能创作工具（基于 Claude AI）

## 🌐 在线演示

- **前端展示页面：** http://home.loadke.tech/
- **后台管理系统：** https://divine-pine-fef2.likhappy.workers.dev/manage
- **小说改编助手：** http://home.loadke.tech/novel-adapter.html

## 📚 新功能：小说改编助手

全新推出的 AI 驱动的小说改编系统，可以将小说内容智能改编为短剧剧本！

### 主要功能

- 📝 **智能分析** - AI 深度分析小说内容，提取核心剧情和人物关系
- 🎬 **剧本生成** - 自动生成标准格式的短剧剧本（6-12集）
- 👥 **角色档案** - 动态生成角色详细信息和发展弧线
- 🔗 **关系图谱** - 可视化展示角色关系网络
- 💾 **项目管理** - 保存和管理多个改编项目
- 📤 **多格式导出** - 支持 Markdown、PDF、纯文本导出

### 快速开始

1. 访问 `novel-adapter.html` 页面
2. 在设置中配置 Claude API Key
3. 创建新项目并上传小说内容
4. 点击"开始分析"，AI 会自动完成改编工作
5. 导出生成的剧本

详细文档：
- [小说改编助手使用指南](NOVEL_ADAPTER_README.md)
